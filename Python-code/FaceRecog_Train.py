...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier(r'C:\Users\aparna\Desktop\AllProjects\Facial-Recognition-for-Crime-Detection-master\haarcascade_frontalface_default.xml')#Load haar classifier
